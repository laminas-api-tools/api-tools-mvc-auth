...
class AclAuthorizationFactoryTest extends TestCase
{
    public function testFactoryGeneratesAclFromConfiguration()
    {
        $config = array(
            ...
            array(
                'resource' => 'LaminasCon\V1\Rest\Session\Controller::resource',
        ...
        $this->assertInstanceOf('Laminas\Permissions\Acl\Acl', $acl);
        ...
        $this->assertTrue($acl->isAllowed('authenticated', 'LaminasCon\V1\Rest\Session\Controller::resource', 'PATCH'));
        $this->assertFalse($acl->isAllowed('guest', 'LaminasCon\V1\Rest\Session\Controller::resource', 'PATCH'));
        $this->assertTrue($acl->isAllowed('authenticated', 'LaminasCon\V1\Rest\Session\Controller::resource', 'DELETE'));
        $this->assertFalse($acl->isAllowed('guest', 'LaminasCon\V1\Rest\Session\Controller::resource', 'DELETE'));
        $this->assertTrue($acl->isAllowed('authenticated', 'LaminasCon\V1\Rest\Session\Controller::resource', 'GET'));
        $this->assertTrue($acl->isAllowed('guest', 'LaminasCon\V1\Rest\Session\Controller::resource', 'GET'));
    ...
    public function testFactoryGeneratesBlacklistAclFromConfiguration()
    {
        ...
        $this->assertTrue($acl->isAllowed('authenticated', 'LaminasCon\V1\Rest\Session\Controller::resource', 'PATCH'));
        $this->assertTrue($acl->isAllowed('authenticated', 'LaminasCon\V1\Rest\Session\Controller::resource', 'GET'));
        $this->assertFalse($acl->isAllowed('guest', 'LaminasCon\V1\Rest\Session\Controller::resource', 'POST'));
        $this->assertTrue($acl->isAllowed('guest', 'LaminasCon\V1\Rest\Session\Controller::resource', 'GET'));
